...
Function LoadSequences(cyc)
 ...
 pSeq(cyc,1072)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Team_Assist.3ds")
 	;Custom New Moves-----------------------------------------------------------------------------
 pSeq(cyc,1075)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/RKO/rko.3ds")
 pSeq(cyc,1082)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/RKO/rko2.3ds")
 pSeq(cyc,1083)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/RKO/rko4.3ds")
 pSeq(cyc,1084)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/The Neutralizer/Execute.3ds")
 pSeq(cyc,1085)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/The Neutralizer/Recieve.3ds")
 pSeq(cyc,1086)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Wasteland/Execute.3ds")
 pSeq(cyc,1087)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Wasteland/Recieve.3ds")
 pSeq(cyc,1088)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Zig Zag/Execute.3ds")
 pSeq(cyc,1089)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Zig Zag/Recieve.3ds")
 pSeq(cyc,1090)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Shell Shock/Execute.3ds")
 pSeq(cyc,1091)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Shell Shock/Recieve.3ds")
 pSeq(cyc,1092)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Cutter/Execute.3ds")
 pSeq(cyc,1093)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Cutter/Recieve.3ds")
 pSeq(cyc,1094)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Trouble In Paradise/Execute.3ds")
 pSeq(cyc,1095)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Trouble In Paradise/Recieve.3ds")
 pSeq(cyc,1096)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Super Kick/Execute.3ds")
 pSeq(cyc,1097)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Super Kick/Recieve.3ds")
 pSeq(cyc,1098)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Kimura Lock/Execute.3ds")
 pSeq(cyc,1099)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Kimura Lock/Recieve.3ds")
	;Random Error Starter Reigon----------------------------------------------------------------------------- 
 pSeq(cyc,950)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Flipping Piledriver/Execute.3ds")
 pSeq(cyc,951)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Flipping Piledriver/Recieve.3ds")
 pSeq(cyc,952)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Muscle Buster/Execute.3ds")
 pSeq(cyc,953)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Muscle Buster/Recieve.3ds")
 pSeq(cyc,954)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Code Breaker/Execute.3ds")
 pSeq(cyc,955)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Code Breaker/Recieve.3ds")
 pSeq(cyc,956)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/TKO/Execute.3ds")
 pSeq(cyc,957)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/TKO/Recieve.3ds")
 pSeq(cyc,958)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Shining Wizard/Execute.3ds")
 pSeq(cyc,959)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Shining Wizard/Recieve.3ds")
 pSeq(cyc,960)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Snapmare Driver/Execute.3ds")
 pSeq(cyc,961)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Snapmare Driver/Recieve.3ds")
 pSeq(cyc,962)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/The People's Elbow/Execute.3ds")
 pSeq(cyc,963)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/The People's Elbow/Recieve.3ds")
 pSeq(cyc,964)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Angle Slam/Execute.3ds")
 pSeq(cyc,965)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Angle Slam/Recieve.3ds")
 pSeq(cyc,966)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Busaiku Knee Kick/Execute.3ds")
 pSeq(cyc,967)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Busaiku Knee Kick/Recieve.3ds") 
 pSeq(cyc,968)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Complete Shot/Execute.3ds")
 pSeq(cyc,969)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Complete Shot/Recieve.3ds")
 pSeq(cyc,970)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Hell's Gate/Execute.3ds")
 pSeq(cyc,971)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Hell's Gate/Recieve.3ds")
 pSeq(cyc,972)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Big End/Execute.3ds")
 pSeq(cyc,973)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Big End/Recieve.3ds")
 pSeq(cyc,974)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Double Arm DDT/Execute.3ds")
 pSeq(cyc,975)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Double Arm DDT/Recieve.3ds")
 pSeq(cyc,976)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Dominator/Execute.3ds")
 pSeq(cyc,977)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Dominator/Recieve.3ds")
 pSeq(cyc,978)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Top Rope Back Suplex/Execute.3ds")
 pSeq(cyc,979)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Top Rope Back Suplex/Recieve.3ds")
 pSeq(cyc,980)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Top Rope German Suplex/Execute.3ds")
 pSeq(cyc,981)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Top Rope German Suplex/Recieve.3ds")
 pSeq(cyc,982)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/World's Strongest Slam/Execute.3ds")
 pSeq(cyc,983)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/World's Strongest Slam/Receive.3ds")
 pSeq(cyc,984)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Styles Clash/Execute.3ds")
 pSeq(cyc,985)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Styles Clash/Receive.3ds")
 pSeq(cyc,986)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Rolling Fireman's Carry/Execute.3ds")
 pSeq(cyc,987)=LoadAnimSeq(p(cyc),"Characters/Sequences/Moves/Rolling Fireman's Carry/Receive.3ds")
...
Function Animations(cyc)
 ...
 If pAnim(cyc)=150
  ...
  If pGrappler(cyc)=0 And (pPinner(cyc)=0 Or pDT(cyc)=<0)
   If pDT(cyc)<optLieHP
    ...
    If game=1 And gamAgreement(11)>0 And pChar(cyc)=gamOpponent(gamDate) And pPinner(cyc)=matchPlayer Then proceed=0
    If game=1 And gamAgreement(12)>0 And cyc=matchPlayer And pChar(pPinner(cyc))=gamOpponent(gamDate) Then proceed=0
 ...
 If pAnim(cyc)=170 Or pAnim(cyc)=171 
  ...
  If pAnimTim(cyc)=Int(50/pAnimSpeed#(cyc))
   ...
   For v=1 To no_plays
    ...
    EndIf
   Next
   If sound>0 Then ProduceSound(cam,sCount(sound),0,1)
   pCountTim(cyc)=0
  EndIf
  If pAnimTim(cyc)=Int(70/pAnimSpeed#(cyc))
   declare=0
  ...
  If newAnim=>0 
   ...
   For v=1 To no_plays
    If RefViable(v)=5 Or RefViable(v)=15
     ...
     If game=1 And gamAgreement(15)>0 And v=matchPlayer Then corruption=1
     If game=1 And gamAgreement(15)>0 And v<>matchPlayer Then corruption=-1
     If game=1 And gamAgreement(16)>0 And v=matchPlayer Then corruption=-1
     If game=1 And gamAgreement(16)>0 And v<>matchPlayer Then corruption=1
    EndIf
   Next 
 ...
 If pAnim(cyc)=179 Or pAnim(cyc)=183
  ...
  If duty=1 And pAnimTim(cyc)>5
   ...
   Else
    If pAnimTim(cyc)=55 Then Pop(v,Rnd(2,8),1)
   EndIf
  ...
  If game=1 And gamAgreement(15)>0 And matchPlayer>0
   If pPinner(v)=matchPlayer Or pGrappler(v)=matchPlayer Then ignore=1
  EndIf
  If game=1 And gamAgreement(16)>0 And matchPlayer>0 And v=matchPlayer Then ignore=1
 ...
 If pAnim(cyc)=181
  ...
  If abort=1 
   ...
   If game=1 And gamAgreement(15)>0 
    If pPinner(v)=matchPlayer Then pCountTim(cyc)=25
    If v=matchPlayer Then pCountTim(cyc)=100
   EndIf
   If game=1 And gamAgreement(16)>0 
    If pPinner(v)=matchPlayer Then pCountTim(cyc)=100
    If v=matchPlayer Then pCountTim(cyc)=25
   EndIf
  EndIf 
 EndIf
 ;declare fall
 ...
 If pAnim(cyc)=232
  ...
  If DirPressed(cyc) 
   ...
   If pAnimTim(cyc)=<Int(15/pAnimSpeed#(cyc)) Or (pAnimTim(cyc)=>Int(30/pAnimSpeed#(cyc)) And pAnimTim(cyc)=<Int(45/pAnimSpeed#(cyc)))
    ...
    ascend#=ascend#*2
   EndIf
   If pPlatform(cyc)=>91 And pPlatform(cyc)=<94 And matchState=3 And matchCountOuts=3 And LegalMan(cyc) And ascend#>0 Then ascend#=ascend#/2
 ...
 If pAnim(cyc)=233
  ...
  EndIf
  If pAnimTim(cyc)=Int(40/pAnimSpeed#(cyc)) And matchState=3 And matchCountOuts=3 And LegalMan(cyc) Then Pop(cyc,2,1) : Pop(cyc,Rnd(2,9),0)
...
Function TauntEffects(cyc,v,tauntTim)
 If v>0 And LegalMan(v) And InProximity(cyc,v,50) And LegalMan(cyc) And matchState=3
