...
Function LoadHeadSequences(cyc)
 ...
 ;kimura lock
 If GroundMoveRequired(cyc,520,1) Then pSeq(cyc,3016)=ExtractAnimSeq(p(cyc),455,520,pSeq(cyc,1098)) ;apply execute
 If GroundMoveRequired(cyc,520,-1) Then pSeq(cyc,3017)=ExtractAnimSeq(p(cyc),455,520,pSeq(cyc,1099)) ;apply receive
 If GroundMoveRequired(cyc,520,1) Then pSeq(cyc,3018)=ExtractAnimSeq(p(cyc),520,565,pSeq(cyc,1098)) ;wrench execute
 If GroundMoveRequired(cyc,520,-1) Then pSeq(cyc,3019)=ExtractAnimSeq(p(cyc),520,565,pSeq(cyc,1099)) ;wrench receive
 ;The People's Elbow--------------------------------------------------------------------------------------------------------
 If GroundMoveRequired(cyc,521,1) Then pSeq(cyc,3032)=ExtractAnimSeq(p(cyc),80,400,pSeq(cyc,962)) ;[execute]
 If GroundMoveRequired(cyc,521,-1) Then pSeq(cyc,3033)=ExtractAnimSeq(p(cyc),80,400,pSeq(cyc,963)) ;[receive]
 ;Hell's Gate
 If GroundMoveRequired(cyc,522,1) Then pSeq(cyc,3046)=ExtractAnimSeq(p(cyc),455,520,pSeq(cyc,970)) ;apply execute
 If GroundMoveRequired(cyc,522,-1) Then pSeq(cyc,3047)=ExtractAnimSeq(p(cyc),455,520,pSeq(cyc,971)) ;apply receive
 If GroundMoveRequired(cyc,522,1) Then pSeq(cyc,3048)=ExtractAnimSeq(p(cyc),520,565,pSeq(cyc,970)) ;wrench execute
 If GroundMoveRequired(cyc,522,-1) Then pSeq(cyc,3049)=ExtractAnimSeq(p(cyc),520,565,pSeq(cyc,971)) ;wrench receive
End Function
...
Function HeadMoves(cyc)
 ...
 If pAnim(cyc)=521
  ...
  If pAnimTim(cyc)=0
   pAnimSpeed#(cyc)=2.80
   Animate p(cyc),1,pAnimSpeed#(cyc),pSeq(cyc,3032),0
   Animate p(v),1,pAnimSpeed#(cyc),pSeq(v,3033),0
   LearnMove(pAnim(cyc))
  EndIf
  If pAnimTim(cyc)=Int(14/pAnimSpeed#(cyc)) Or pAnimTim(cyc)=Int(41/pAnimSpeed#(cyc)) Or pAnimTim(cyc)=Int(180/pAnimSpeed#(cyc)) Then ProduceSound(p(cyc),sShuffle(Rnd(1,3)),0,0)
  If pAnimTim(cyc)=Int(27/pAnimSpeed#(cyc)) Or pAnimTim(cyc)=Int(200/pAnimSpeed#(cyc)) Or pAnimTim(cyc)=Int(200/pAnimSpeed#(cyc)) Then pStepTim#(cyc)=200
  If pAnimTim(cyc)=Int(45/pAnimSpeed#(cyc)) Then ProduceSound(p(cyc),sFall,22050,0.5)
  If pAnimTim(cyc)=Int(75/pAnimSpeed#(cyc)) Or pAnimTim(cyc)=Int(200/pAnimSpeed#(cyc)) Or pAnimTim(cyc)=Int(200/pAnimSpeed#(cyc)) Or pAnimTim(cyc)=Int(200/pAnimSpeed#(cyc))
   ProduceSound(p(cyc),sSwing,21000,0.5)
  EndIf
  If pAnimTim(cyc)=Int(88/pAnimSpeed#(cyc)) Or pAnimTim(cyc)=Int(200/pAnimSpeed#(cyc)) Or pAnimTim(cyc)=Int(200/pAnimSpeed#(cyc)) Or pAnimTim(cyc)=Int(200/pAnimSpeed#(cyc))
   Pop(cyc,Rnd(2,8),0)
   If pHolding(cyc)=0 Or weapWear(pHolding(cyc))>0 Then ProduceSound(p(cyc),sImpact(Rnd(1,4)),22050,0)
   If pHolding(cyc)>0 And weapWear(pHolding(cyc))=0 Then ProduceSound(p(cyc),sImpact(Rnd(1,4)),22050,0.5)
   ProduceSound(p(v),sPain(Rnd(1,8)),GetVoice(v),0)
  ...
  EndIf
  If pAnimTim(cyc)>Int(318/pAnimSpeed#(cyc));--------------320
   ChangeAnim(cyc,154) : SharpTransition(cyc,154,1,1)
   ChangeAnim(v,150)
   EndMove(cyc,v)
   If matchState=3 And pEliminated(v)=0 Then pDT(v)=0
  EndIf
 ...
 If pAnim(cyc)=522
  ...
  If pAnimStage(cyc)=2
   If pAnimTim(cyc)=0
    ...
    Animate p(v),1,pAnimSpeed#(cyc),pSeq(v,animB+2),5
   EndIf
   HoldEffects(cyc,v,2,0.05,1);----(2,0.05,1)
  EndIf
  ;leave
  If pAnimStage(cyc)=3
   If pAnimTim(cyc)=0 
...
Function HoldEffects(cyc,v,power,crawl#,orientation) ;1=mild, 2=average, 3=powerful
 ...
 If randy=<1 And pHolding(cyc)>0 And weapWear(pHolding(cyc))=0 Then ProduceSound(p(cyc),weapSound(weapType(pHolding(cyc))),22050,Rnd#(0.1,0.5))
 ...
 ;learn move
 If pAnimTim(cyc)=0 Then LearnMove(pAnim(cyc))
End Function
