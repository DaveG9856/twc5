...
;Opening Movie
file=OpenMovie("Graphics/Intro.wmv")
Repeat
Cls
DrawMovie(file,0,0,GraphicsWidth(),GraphicsHeight())
Flip
Until KeyHit(1) Or KeyDown(57) Or KeyHit(156) Or MouseDown(1) Or KeyHit(28) Or (Not MoviePlaying(file))
CloseMovie(file)

;prepare images
size=8
For count=0 To 16
 font(count)=LoadFont("Universal Serif.ttf",size,0,0,0)
 size=size+2
Next 
...
pSeq(cyc,604)=LoadAnimSeq(p(cyc),"Characters/Sequences/Standard06.3ds")
pSeq(cyc,1)=ExtractAnimSeq(p(cyc),2530,2590,pSeq(cyc,604)) ;standing still
pSeq(cyc,2)=ExtractAnimSeq(p(cyc),835,900,pSeq(cyc,604)) ;gesture
...
RemoveHeadwear(cyc)
RemoveEyewear(cyc)
tHat(0)=LoadTexture("Characters/intro/Hat09.JPG")
ShowEntity FindChild(p(cyc),"Cap")
EntityTexture FindChild(p(cyc),"Cap"),tHat(0),0,1
PositionEntity FindChild(p(cyc),"Cap"),2.43,41.62,5.14 
RotateEntity FindChild(p(cyc),"Cap"),20,-18.9,-7.4
tHair(0)=LoadTexture("Characters/Hair/Hair01.JPG")
EntityAlpha FindChild(p(cyc),"H_Bald"),1
EntityTexture FindChild(p(cyc),"H_Bald"),tHair(0);,0,1
tFace(0)=LoadTexture("Characters/Faces/Face07.JPG")
tEars=LoadTexture("Characters/Expressions/Ears.JPG")
tEyes(0)=LoadTexture("Characters/Expressions/Eyes01.JPG")
...
Next
tEyeballs(0)=LoadTexture("Characters/intro/Eyes02.JPG")
For limb=45 To 46
 EntityTexture pLimb(cyc,limb),tEyeballs(0),0,1
Next
tBody(0)=LoadTexture("Characters/intro/Body52.JPG")
EntityTexture pLimb(cyc,5),tBody(0),0,1
EntityAlpha FindChild(p(cyc),"Body"),0
tArm(0)=LoadTexture("Characters/intro/Arm16 (5).JPG")
tHands(0)=LoadTexture("Characters/intro/Hands01 (1).JPG")
For limb=6 To 31
 ...
 EndIf
Next
tLegs(0)=LoadTexture("Characters/intro/Legs107.JPG")
For limb=36 To 44
...
While go=0
 ...
 SetFont font(2) 
 Color 100,100,100
 Text rX#(400)+165,rY#(135)+62,"vB1.1",0,1
 ;cursor
...
While go=0
 ...
 SetFont font(9)
 Outline("Based on Code by MDickie",rX#(400),rY#(y+scroll),0,0,0,250,250,250) : y=y+65
 Outline("Game Design",rX#(400),rY#(y+scroll),0,0,0,250,235,45) : y=y+38
 Outline("David Granlet & Mat Dickie",rX#(400),rY#(y+scroll),0,0,0,250,250,250) : y=y+65
 ...
 Outline("Steve, Members of Mpiremall & Mat Dickie",rX#(400),rY#(y+scroll),0,0,0,250,250,250) : y=y+65
 Outline("3D Modelling",rX#(400),rY#(y+scroll),0,0,0,235,180,30) : y=y+38
 Outline("Steve & Mat Dickie",rX#(400),rY#(y+scroll),0,0,0,250,250,250) : y=y+65
 Outline("Animation",rX#(400),rY#(y+scroll),0,0,0,230,155,25) : y=y+38
 Outline("Steve & Mat Dickie",rX#(400),rY#(y+scroll),0,0,0,250,250,250) : y=y+65
 Outline("Texturing",rX#(400),rY#(y+scroll),0,0,0,225,130,20) : y=y+38
 Outline("Members of Mpiremall & Mat Dickie",rX#(400),rY#(y+scroll),0,0,0,250,250,250) : y=y+25
 SetFont font(1)
 Outline("(Steel chair courtesy of Simon Sayers)",rX#(400),rY#(y+scroll),0,0,0,200,200,200) : y=y+55
 SetFont font(9)
 Outline("Move Code",rX#(400),rY#(y+scroll),0,0,0,220,105,15) : y=y+38
 Outline("Demontra Calhoun",rX#(400),rY#(y+scroll),0,0,0,250,250,250) : y=y+65
 Outline("Intro Movie Code",rX#(400),rY#(y+scroll),0,0,0,215,80,10) : y=y+38
 Outline("Demontra Calhoun",rX#(400),rY#(y+scroll),0,0,0,250,250,250) : y=y+25
 SetFont font(1)
...
While go=0
 ...
 Outline("www.mpiremall.info",rX#(400),rY#(360)+45,0,0,0,255,255,255)
