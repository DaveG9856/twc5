...
;0=character selection, 1=editing, 2=studying rosters, 3=hiring manager, 4=arrange match, 5=starting career
;6=recruiting partner, 7=setting relationships, 8=setting real relationships
;10=sparring, 11=tournament, 12=brawl, 13=serving as ref, 14=serving as manager, 15=second match
...
.Options
;constants
Global optPlayLim=50,optCharLim=325,optRosterLim=68
Global optLieHP=150,optCrawlHP=75
;frame rates
...
Global optTrainLevel=2 ;1-3, 0=automated
...
;display preferences
Global optGameRes=3,optMenuRes=3,optWindow=0
Global optDefaultCam=5,optEntranceCam=1 ;1=in front, 2=behind, 3=spontaneous, 4=first person
Global optFX=1,optShadows=1,optGore=4 ;0=none, 1=scars, 2=pools, 3=limbs, 4=extreme
Global optFog=1,optDetail=1 ;0=bare backstage areas, 1=banners removed, 2=maximum
Global optContent=1 ;0=minimum, 1=moderate, 2=maximum
...
slotActive(0)=1
;career status
Global targetSlot,gamInherit
Global game,gamChar,gamCasted
Dim gamCastList(optPlayLim)
Dim gamNegotiated(optCharLim,3) ;1=recruit partner, 2=hire manager, 3=arrange match
Dim gamFinances(10,2)
Global gamTicket,gamBonus
Global gamGimmickChanges
Global gamNewMoves,gamNewAttacks,gamNewTaunts
Global gamNewCostumes,gamNewMusic
Global gamFatality,gamNewcomer
;1=changed name, 2=hairstyle, 3=costume, 4=entrance, 5=attacks, 6=moves, 7=gestures, 8=allegiance
;10=work through injury, 11=opponent due to lie down, 12=player due to lie down, 13=used steroids, 14=used painkillers
;15=favourable ref, 16=unfavourable ref, 17=product endorsement, 18=power failure, 19=no items, 20=no crowd
;21=promised contract offer
Dim gamAgreement(50)
;schedule
...
Dim gamGimmick(100)
Dim gamPromo(100)
Dim gamPromoVariable(100)
Dim gamResult(100) ;0=not played, 1=loss, 2=tie, 3=win
;arena status
Dim gamVenue(100)
Dim gamAtmos(100)
...
;negotiations
Global negChar,negSetting,negVariable
Global negTopic,negTim,negStage,negSubStage
Global negWorth,negContractWorth,negClauseWorth
Global negPaymentTotal,negInitialPaymentTotal,negPaymentLimit
Global negChances,negVerdict,negInterest
Global negPayOff,negSalary,negContract
Global negInitialPayOff,negInitialSalary,negInitialContract
Dim negClause(3),negInitialClause(3)
Dim negFocus(2) ;order of characters in conferences
Dim negTopicUsed(50) ;topics used in conferences
Dim negReaction(5) ;reaction to comment in conferences
;match arrangements
Global negDate,negInitialDate
Global negMatch,negInitialMatch
Global negGimmick,negInitialGimmick
Global negVenue,negInitialVenue
Dim negDatePrefer(50)
Dim negMatchPrefer(30)
Dim negGimmickPrefer(20)
Dim negVenuePrefer(30)
;news events
Global no_events
Dim eEvent(200)
Dim eChar(200)
...
Dim hiWealth(10),hiTitles(10)
Dim hiSuccess(10),hiTalent(10)
Dim hiExperience(10),hiFed(10)
...
.Sound
;effects
Global sMenuBrowse=LoadSound("Sound/Browse.ogg")
Global sMenuSelect=LoadSound("Sound/Select.ogg")
Global sMenuGo=LoadSound("Sound/Confirm.ogg")
Global sMenuBack=LoadSound("Sound/Cancel.ogg")
Global sVoid=LoadSound("Sound/Void.ogg")
Global sCamera=LoadSound("Sound/Camera.ogg")
Global sPaper=LoadSound("Sound/Paper.ogg")
Global sCash=LoadSound("Sound/Cash.ogg")
Global sTrash=LoadSound("Sound/Trash.ogg")
Global sWhistle=LoadSound("Sound/Whistle.ogg")
;world
Global sBell=Load3DSound("Sound/Bell.ogg")
Global sBuzzer=Load3DSound("Sound/Buzzer.ogg")
;movements
Dim sShuffle(3)
For count=1 To 3
 sShuffle(count)=Load3DSound("Sound/Movement/Shuffle0"+count+".ogg")
Next
Dim sStep(6)
For count=1 To 6
 sStep(count)=Load3DSound("Sound/Movement/Step0"+count+".ogg")
Next
Global sFall=Load3DSound("Sound/Movement/Fall.ogg")
Global sThud=Load3DSound("Sound/Movement/Thud.ogg")
Global sRope=Load3DSound("Sound/Movement/Rope.ogg")
Global sSwing=Load3DSound("Sound/Movement/Swing.ogg")
;impacts
Global sBleed=Load3DSound("Sound/Impacts/Bleed.ogg")
Dim sImpact(7) ;1-4=weak, 5-6=strong, 7=major
Dim sBlock(7)
For count=1 To 7
 sImpact(count)=Load3DSound("Sound/Impacts/Impact"+Dig$(count,10)+".ogg")
 sBlock(count)=Load3DSound("Sound/Impacts/Block"+Dig$(count,10)+".ogg")
Next
;weapon impacts
Global sStab=Load3DSound("Sound/Props/Stab.ogg")
Global sImpactBell=Load3DSound("Sound/Props/Impact_Bell.ogg")
Global sImpactBlade=Load3DSound("Sound/Props/Impact_Blade.ogg")
Global sImpactBottle=Load3DSound("Sound/Props/Impact_Bottle.ogg")
Global sImpactCane=Load3DSound("Sound/Props/Impact_Cane.ogg")
Global sImpactGun=Load3DSound("Sound/Props/Impact_Gun.ogg")
Global sImpactHammer=Load3DSound("Sound/Props/Impact_Hammer.ogg")
Global sImpactMetal=Load3DSound("Sound/Props/Impact_Metal.ogg")
Global sImpactMic=Load3DSound("Sound/Props/Impact_Mic.ogg")
Global sImpactWood=Load3DSound("Sound/Props/Impact_Wood.ogg")
Global sImpactTacks=Load3DSound("Sound/Props/Impact_Tacks.ogg")
;item smashes
Global sItem=Load3DSound("Sound/Props/Item.ogg")
Global sSmashCard=Load3DSound("Sound/Props/Smash_Card.ogg")
Global sSmashElectric=Load3DSound("Sound/Props/Smash_Electric.ogg")
Global sSmashGlass=Load3DSound("Sound/Props/Smash_Glass.ogg")
Global sSmashMetal=Load3DSound("Sound/Props/Smash_Metal.ogg")
Global sSmashPlastic=Load3DSound("Sound/Props/Smash_Plastic.ogg")
Global sSmashWire=Load3DSound("Sound/Props/Smash_Wire.ogg")
Global sSmashWood=Load3DSound("Sound/Props/Smash_Wood.ogg")
;elements
Global sFire=Load3DSound("Sound/Props/Fire.ogg")
Global sIgnite=Load3DSound("Sound/Props/Ignite.ogg")
Global sExpire=Load3DSound("Sound/Props/Expire.ogg") 
Global sExplosion=Load3DSound("Sound/Props/Explosion.ogg")
Global sElectric=Load3DSound("Sound/Props/Electricity.ogg")
Global sPower=Load3DSound("Sound/Props/Power.ogg")
Global sSplash=Load3DSound("Sound/Props/Splash.ogg")
;pain
Dim sPain(10)
For count=1 To 8
 sPain(count)=Load3DSound("Sound/Pain/Pain0"+count+".ogg")
Next
Dim sAgony(5)
For count=1 To 3
 sAgony(count)=Load3DSound("Sound/Pain/Agony0"+count+".ogg")
Next
Global sChoke=Load3DSound("Sound/Pain/Choke.ogg")
;referee
Global sDQ=Load3DSound("Sound/Speech/DQ.ogg")
Global sRopeBreak=Load3DSound("Sound/Speech/Break.ogg")
Dim sCount(10)
For count=1 To 10
 sCount(count)=Load3DSound("Sound/Speech/Count"+Dig$(count,10)+".ogg")
Next
;crowd
...
Dim sCrowd(12)
sCrowd(0)=LoadSound("Sound/Crowd/Empty.ogg")
sCrowd(1)=LoadSound("Sound/Crowd/Loop.ogg")
sCrowd(2)=LoadSound("Sound/Crowd/Cheer.ogg")
sCrowd(3)=LoadSound("Sound/Crowd/Boo.ogg")
sCrowd(4)=LoadSound("Sound/Crowd/Yay.ogg")
sCrowd(5)=LoadSound("Sound/Crowd/Groan.ogg")
sCrowd(6)=LoadSound("Sound/Crowd/Excitement.ogg")
sCrowd(7)=LoadSound("Sound/Crowd/Murmur.ogg")
sCrowd(8)=LoadSound("Sound/Crowd/Laughter.ogg")
sCrowd(9)=LoadSound("Sound/Crowd/Applause.ogg")
sCrowd(10)=LoadSound("Sound/Crowd/Chant.ogg")
sCrowd(11)=LoadSound("Sound/Crowd/Bored.ogg")
;music
Global optMusicVolume=80,optJukeBox=0
Global chTheme,chCurrentTheme,chThemeChange
Global chThemeVol#,chThemeTarget#,chThemePitch

Global sMainTheme=LoadSound("Sound/Theme.ogg")
Global no_themes
Dim sTheme(100)
...
Function LoadMusic()
 ...
 For count=0 To 99
  sTheme(count)=LoadSound("Music/Theme"+Dig$(count,10)+".ogg")
...
Function LoadImages()
 ...
 size=8
 For count=0 To 16
  font(count)=LoadFont("DAYROM__.ttf",size,255,0,255)
  size=size+2
 Next 
 ;news font (3=news, 8=promo, 10=headline)
 fontNews(0)=LoadFont("DAYROM__.ttf",12,255,0,255)
 size=15
 For count=1 To 11
  fontNews(count)=LoadFont("DAYROM__.ttf",size,1,0,0)
  size=size+3
 Next 
 ;stat font
 fontStat(0)=LoadFont("DAYROM__.ttf",13,255,0,255)
 fontStat(1)=LoadFont("DAYROM__.ttf",16,1,0,0)
 fontStat(2)=LoadFont("DAYROM__.ttf",20,1,0,0)
 fontStat(3)=LoadFont("DAYROM__.ttf",24,1,0,0)
 fontStat(4)=LoadFont("DAYROM__.ttf",28,1,0,0)
 fontStat(5)=LoadFont("DAYROM__.ttf",32,1,0,0)
 fontStat(6)=LoadFont("DAYROM__.ttf",36,1,0,0)  
 ;background
 gBackground=LoadImage("Graphics/Background.png")
 MaskImage gBackground,0,0,0
 ...
 Next 
 ;misc icons
 gCursor=LoadImage("Graphics/Cursor01.png")
 MaskImage gCursor,0,0,0
 ...
 For count=1 To 6 ;new belts orig = 3
...
folder=ReadDir(CurrentDir$()+"Characters/Headwear/")
 Repeat
  ...
  If FileType(CurrentDir$()+"Characters/Headwear/"+filename$)=1 And namer$="HAT" And no_hats<300 Then no_hats=no_hats+1
 Until filename$=""
CloseDir(folder)
;count hair textures
Global no_hairs=0
folder=ReadDir(CurrentDir$()+"Characters/Hair/")
 Repeat
  ...
  If FileType(CurrentDir$()+"Characters/Hair/"+filename$)=1 And namer$="HAIR" And no_hairs<300 Then no_hairs=no_hairs+1
 Until filename$=""
CloseDir(folder)
...
folder=ReadDir(CurrentDir$()+"Characters/Faces/")
 Repeat
  filename$=NextFile$(folder)
  namer$=Upper$(Left$(filename$,4))
  If FileType(CurrentDir$()+"Characters/Faces/"+filename$)=1 And namer$="FACE" And no_faces<300 Then no_faces=no_faces+1
 Until filename$=""
CloseDir(folder)
;count eye textures
Global no_eyes=0
...
folder=ReadDir(CurrentDir$()+"Characters/Bodies/")
 Repeat
  filename$=NextFile$(folder)
  namer$=Upper$(Left$(filename$,4))
  If FileType(CurrentDir$()+"Characters/Bodies/"+filename$)=1 And namer$="BODY" And no_bodies<300 Then no_bodies=no_bodies+1
 Until filename$=""
CloseDir(folder)
;count arm textures
Global no_arms=0
folder=ReadDir(CurrentDir$()+"Characters/Arms/")
 Repeat
  filename$=NextFile$(folder)
  namer$=Upper$(Left$(filename$,3))
  If FileType(CurrentDir$()+"Characters/Arms/"+filename$)=1 And namer$="ARM" And no_arms<300 Then no_arms=no_arms+1
 Until filename$=""
CloseDir(folder)
;count hand textures
Global no_hands=0
...
folder=ReadDir(CurrentDir$()+"Characters/Legs/")
 Repeat
  filename$=NextFile$(folder)
  namer$=Upper$(Left$(filename$,4))
  If FileType(CurrentDir$()+"Characters/Legs/"+filename$)=1 And namer$="LEGS" And no_legs<300 Then no_legs=no_legs+1
 Until filename$=""
CloseDir(folder)
;world variables
Dim tCrowd(5)
...
;costume variables
Global tEars,tPony
Dim tEyes(5),tEyeballs(no_eyes)
Dim tMouth(5)
Dim tSpecs(3)
Dim tHat(300),tHatAccess(300)
Dim tShaved(10),tBeard(no_beards)
Dim tHair(300),tHairAccess(300)
Dim tFace(300),tFaceType(300),tFaceAccess(300)
Dim tBody(300),tBodyType(300),tBodyAccess(300)
Dim tArm(300),tArmType(300),tArmAccess(300)
Dim tHands(300),tHandType(300),tHandsAccess(300)
Dim tLegs(300),tLegType(300),tLegsAccess(300)
...
Function LoadTextures()
 ...
 tScreen=LoadTexture("World/Videos/Screen.JPG",64)
 ;cages
 For count=1 To 3
 ...
 Next
 tGlass(1)=LoadTexture("Items/Textures/Glass01.png",4)
 ...
 For count=1 To 3
  labCount(count)=LoadTexture("World/Sprites/Labels/Count0"+count+".png",12)
 Next
 labSpecial=LoadTexture("World/Sprites/Labels/Special.png",12)
 labWarning=LoadTexture("World/Sprites/Labels/Warning.png",12)
 labInjured=LoadTexture("World/Sprites/Labels/Injured.png",12)
 labEliminated=LoadTexture("World/Sprites/Labels/Eliminated.png",12)
 labLegal=LoadTexture("World/Sprites/Labels/Legal.png",12)
 labOut=LoadTexture("World/Sprites/Labels/Out.png",12)
 labControl=LoadTexture("World/Sprites/Labels/Control.png",12)
End Function
...
;new belts
Dim fedOldChampWomens(10)
Dim fedOldChampUS(10)
Dim fedOldChampTV(10)
;end
Dim fedOldChampTag(10,2)
Dim fedHistCount(10,7,10);New belts orig =10,4,10
Dim fedHistChar(10,7,10);New belts orig =10,4,10
Dim fedHistPartner(10,7,10);New belts orig =10,4,10
Dim fedHistDate(10,7,10);New belts orig =10,4,10
Dim fedHistYear(10,7,10);New belts orig =10,4,10
;rankings
Dim fedList(10)
Dim fedOldList(10)
Dim fedRanked(10)
...
;new belts
Dim charTitles(optCharLim,9,7) ;1=world, 2=inter, 3=tag, 4=cups , 5=Womens , 6=US , 7=TV
;end
...
Global editScroll,editFilter=9,editPoints
...
Global no_hairstyles=49,no_tattoos=9
Global no_lightshows=11
Global hatX#,hatY#,hatZ#
Global hatXA#,hatYA#,hatZA#
Dim costumeLearned(3,300) ;1=body, 2=arms, 3=legs
;stat pursuits
Dim statLevel(6)
statLevel(1)=30
statLevel(2)=50
...
n=23 : attackName$(3,n)="Spear"
attackAnimSource(3,n)=1010 : attackAnimStart(3,n)=3930 : attackAnimEnd(3,n)=4045
attackTransition(3,n)=20 : attackSpeed#(3,n)=2.8 : attackLength(3,n)=attackTransition(3,n)+105
attackTravel#(3,n)=0.75 : attackMomentum(3,n)=attackTransition(3,n)+65 : attackFall(3,n)=attackTransition(3,n)+40
attackActive(3,n)=attackTransition(3,n)+15 : attackImpact(3,n)=attackTransition(3,n)+35 : attackExpire(3,n)=attackTransition(3,n)+35
attackRange#(3,n)=12 : attackHeight#(3,n)=26 : attackPower(3,n)=400 : attackLimb(3,n)=1 : attackWeapon(3,n)=1
...
n=12 : CopyAttack(3,23,4,n) ;spear copy
n=13 : CopyAttack(3,1,4,n) ;double-axe handle copy
attackList(4)=n
;flying attacks
attackList(5)=4
...
crushRange#(3,n)=12 : crushPower(3,n)=300 : crushLimb(3,n)=36 : crushWeapon(3,n)=1
n=8 : crushName$(3,n)="Swanton Bomb"
crushAnimSource(3,n)=1010 : crushAnimStart(3,n)=3247 : crushAnimEnd(3,n)=3427
crushTransition(3,n)=20 : crushSpeed#(3,n)=3.0 : crushLength(3,n)=crushTransition(3,n)+175
crushTravel#(3,n)=1.0 : crushMomentum(3,n)=crushTransition(3,n)+105 : crushFall(3,n)=crushTransition(3,n)+60
crushImpactHigh(3,n)=crushTransition(3,n)+40 : crushImpactLow(3,n)=crushTransition(3,n)+55
crushRange#(3,n)=10 : crushPower(3,n)=350 : crushLimb(3,n)=36 : crushWeapon(3,n)=1
;running
...
;flying
crushList(5)=12
n=1 : crushName$(5,n)="Diving Splash"
...
crushRange#(5,n)=25 : crushPower(5,n)=2000 : crushLimb(5,n)=0 : crushWeapon(5,n)=1
n=2 : crushName$(5,n)="Frog Splash"
crushAnimSource(5,n)=1009 : crushAnimStart(5,n)=2755 : crushAnimEnd(5,n)=2875
crushTransition(5,n)=0 : crushSpeed#(5,n)=3.0 : crushLength(5,n)=120
crushTravel#(5,n)=20 : crushMomentum(5,n)=100 : crushFall(5,n)=2 : crushTope(5,n)=1
crushRange#(5,n)=25 : crushPower(5,n)=2000 : crushLimb(5,n)=0 : crushWeapon(5,n)=1
n=3 : crushName$(5,n)="Diving Moonsault"
...
crushRange#(5,n)=20 : crushPower(5,n)=2000 : crushLimb(5,n)=0 : crushWeapon(5,n)=1
n=7 : crushName$(5,n)="Diving Leg Drop"
...
crushRange#(5,n)=22 : crushPower(5,n)=2000 : crushLimb(5,n)=43 : crushWeapon(5,n)=1
n=8 : crushName$(5,n)="Diving Knee Drop"
...
crushRange#(5,n)=16 : crushPower(5,n)=2000 : crushLimb(5,n)=43 : crushWeapon(5,n)=1
n=9 : crushName$(5,n)="Diving Elbow Drop"
...
crushRange#(5,n)=20 : crushPower(5,n)=2000 : crushLimb(5,n)=20 : crushWeapon(5,n)=1
n=10 : crushName$(5,n)="Swanton Bomb"
crushAnimSource(5,n)=1010 : crushAnimStart(5,n)=3247 : crushAnimEnd(5,n)=3427
crushTransition(5,n)=0 : crushSpeed#(5,n)=2.30 : crushLength(5,n)=85
crushTravel#(5,n)=100 : crushMomentum(5,n)=200 : crushFall(5,n)=1 : crushTope(5,n)=1
crushRange#(5,n)=20 : crushPower(5,n)=3000 : crushLimb(5,n)=0 : crushWeapon(5,n)=1
n=11 : crushName$(5,n)="Diving Headbutt"
crushAnimSource(5,n)=1009 : crushAnimStart(5,n)=3400 : crushAnimEnd(5,n)=3519
crushTransition(5,n)=0 : crushSpeed#(5,n)=2.4 : crushLength(5,n)=119
crushTravel#(5,n)=20 : crushMomentum(5,n)=500 : crushFall(5,n)=2 : crushTope(5,n)=1
crushRange#(5,n)=25 : crushPower(5,n)=3000 : crushLimb(5,n)=0 : crushWeapon(5,n)=1
n=12 : crushName$(5,n)="Diving Elbow"
crushAnimSource(5,n)=1009 : crushAnimStart(5,n)=3520 : crushAnimEnd(5,n)=3641
crushTransition(5,n)=0 : crushSpeed#(5,n)=3.0 : crushLength(5,n)=121
crushTravel#(5,n)=20 : crushMomentum(5,n)=110 : crushFall(5,n)=2 : crushTope(5,n)=0
crushRange#(5,n)=20 : crushPower(5,n)=2000 : crushLimb(5,n)=20 : crushWeapon(5,n)=1
...
n=32 : moveName$(1,n)="Jackhammer" : moveAnim(1,n)=322
...
n=43 : moveName$(1,n)="Scoop Slam" : moveAnim(1,n)=316
...
n=72 : moveName$(1,n)="Crucifix Powerbomb" : moveAnim(1,n)=380
...
n=82 : moveName$(1,n)="RKO" : moveAnim(1,n)=390 ;-------------------------------------------------------------------NEW MOVES!!!!!
n=83 : moveName$(1,n)="The Neutralizer" : moveAnim(1,n)=391
n=84 : moveName$(1,n)="Wasteland" : moveAnim(1,n)=392
n=85 : moveName$(1,n)="Zig Zag" : moveAnim(1,n)=393
n=86 : moveName$(1,n)="Shell Shock" : moveAnim(1,n)=394
n=87 : moveName$(1,n)="Cutter (Twist Of Fate)" : moveAnim(1,n)=395
n=88 : moveName$(1,n)="Trouble In Paradise" : moveAnim(1,n)=396
n=89 : moveName$(1,n)="Super Kick" : moveAnim(1,n)=397
n=90 : moveName$(1,n)="Flipping Piledriver" : moveAnim(1,n)=398
n=91 : moveName$(1,n)="Muscle Buster" : moveAnim(1,n)=399
n=92 : moveName$(1,n)="Codebreaker" : moveAnim(1,n)=400
n=93 : moveName$(1,n)="TKO" : moveAnim(1,n)=401
n=94 : moveName$(1,n)="Shining Wizard" : moveAnim(1,n)=402
n=95 : moveName$(1,n)="Snapmare Driver" : moveAnim(1,n)=403
n=96 : moveName$(1,n)="Angle Slam" : moveAnim(1,n)=404
n=97 : moveName$(1,n)="Busaiku Knee Kick" : moveAnim(1,n)=405
n=98 : moveName$(1,n)="Complete Shot" : moveAnim(1,n)=406
n=99 : moveName$(1,n)="The Big Ending" : moveAnim(1,n)=407
n=100 : moveName$(1,n)="Double Arm DDT" : moveAnim(1,n)=408
n=101 : moveName$(1,n)="Front Powerslam (Dominator)" : moveAnim(1,n)=409
n=102 : moveName$(1,n)="Falling Powerslam" : moveAnim(1,n)=410
n=103 : moveName$(1,n)="Styles Clash" : moveAnim(1,n)=411
n=104 : moveName$(1,n)="Rolling Fireman's Carry" : moveAnim(1,n)=412
n=105 : moveName$(1,n)="Batista Bomb" : moveAnim(1,n)=413
moveList(1)=n
;corner moves
moveList(2)=8
n=1 : moveName$(2,n)="Throw Down" : moveAnim(2,n)=710
...
n=6 : moveName$(2,n)="Frankinstiener" : moveAnim(2,n)=715
n=7 : moveName$(2,n)="Back Suplex" : moveAnim(2,n)=716
n=8 : moveName$(2,n)="German Suplex" : moveAnim(2,n)=717
;head moves
moveList(3)=13
n=1 : moveName$(3,n)="Pick Up (From Head)" : moveAnim(3,n)=510
...
n=10 : moveName$(3,n)="Crossface Crippler" : moveAnim(3,n)=517
n=11 : moveName$(3,n)="Kimura Lock" : moveAnim(3,n)=520 ;-------------------------------------------------------------------NEW MOVES!!!!!
n=12 : moveName$(3,n)="Jumping Elbow" : moveAnim(3,n)=521
n=13 : moveName$(3,n)="Hell's Gate" : moveAnim(3,n)=522
;leg moves
moveList(4)=11
n=1 : moveName$(4,n)="Pick Up (From Legs)" : moveAnim(4,n)=610
n=2 : moveName$(4,n)="Slingshot" : moveAnim(4,n)=619
n=3 : moveName$(4,n)="Groin Stomp" : moveAnim(4,n)=612
n=4 : moveName$(4,n)="Spinning Toe Hold" : moveAnim(4,n)=617
n=5 : moveName$(4,n)="Side Leglock" : moveAnim(4,n)=618
n=6 : moveName$(4,n)="One-Legged Crab" : moveAnim(4,n)=614
n=7 : moveName$(4,n)="Boston Crab" : moveAnim(4,n)=613
n=8 : moveName$(4,n)="Wall Of Jericho" : moveAnim(4,n)=615
n=9 : moveName$(4,n)="Sharpshooter" : moveAnim(4,n)=611
...
tauntTransition(n)=15 : tauntLength(n)=60 : tauntLoop(n)=1
n=70 : tauntName$(n)="Peace" ;-------------------------------------------------------------------NEW TAUNTS!!!!!
tauntAnimStart(n)=2826 : tauntAnimEnd(n)=2855
tauntAnimSource(n)=1010 : tauntSpeed#(n)=0.5
tauntTransition(n)=15 : tauntLength(n)=29 : tauntLoop(n)=0
n=71 : tauntName$(n)="Intelligence"
tauntAnimStart(n)=2857 : tauntAnimEnd(n)=2955
tauntAnimSource(n)=1010 : tauntSpeed#(n)=0.9
tauntTransition(n)=8 : tauntLength(n)=98 : tauntLoop(n)=0
n=72 : tauntName$(n)="Rock On!"
tauntAnimStart(n)=2956 : tauntAnimEnd(n)=3025
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.0
tauntTransition(n)=8 : tauntLength(n)=69 : tauntLoop(n)=0
n=73 : tauntName$(n)="Impressive"
tauntAnimStart(n)=3026 : tauntAnimEnd(n)=3085
tauntAnimSource(n)=1010 : tauntSpeed#(n)=0.8
tauntTransition(n)=15 : tauntLength(n)=59 : tauntLoop(n)=0
n=74 : tauntName$(n)="Hold Up"
tauntAnimStart(n)=3086 : tauntAnimEnd(n)=3156
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.3
tauntTransition(n)=15 : tauntLength(n)=70 : tauntLoop(n)=0
n=75 : tauntName$(n)="Straight Edge"
tauntAnimStart(n)=3157 : tauntAnimEnd(n)=3213
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.0
tauntTransition(n)=15 : tauntLength(n)=60 : tauntLoop(n)=0
n=76 : tauntName$(n)="Introducing"
tauntAnimStart(n)=2600 : tauntAnimEnd(n)=2660
tauntAnimSource(n)=1004 : tauntSpeed#(n)=1.0
tauntTransition(n)=15 : tauntLength(n)=60 : tauntLoop(n)=0
n=77 : tauntName$(n)="Prepared"
tauntAnimStart(n)=790 : tauntAnimEnd(n)=1155
tauntAnimSource(n)=1001 : tauntSpeed#(n)=3.5
tauntTransition(n)=15 : tauntLength(n)=365 : tauntLoop(n)=0
n=78 : tauntName$(n)="Ministry Throat Slice"
tauntAnimStart(n)=3430 : tauntAnimEnd(n)=3505
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.0
tauntTransition(n)=15 : tauntLength(n)=75 : tauntLoop(n)=0
n=79 : tauntName$(n)="Enigma"
tauntAnimStart(n)=3506 : tauntAnimEnd(n)=3580
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.1
tauntTransition(n)=15 : tauntLength(n)=74 : tauntLoop(n)=0
n=80 : tauntName$(n)="Boom Boom!"
tauntAnimStart(n)=3581 : tauntAnimEnd(n)=3660
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.2
tauntTransition(n)=8 : tauntLength(n)=79 : tauntLoop(n)=1
n=81 : tauntName$(n)="Suicide"
tauntAnimStart(n)=3660 : tauntAnimEnd(n)=3746
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.3
tauntTransition(n)=15 : tauntLength(n)=86 : tauntLoop(n)=0
n=82 : tauntName$(n)="Ape Shit"
tauntAnimStart(n)=3747 : tauntAnimEnd(n)=3833
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.3
tauntTransition(n)=15 : tauntLength(n)=86 : tauntLoop(n)=1
n=83 : tauntName$(n)="Game On"
tauntAnimStart(n)=3834 : tauntAnimEnd(n)=3920
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.1
tauntTransition(n)=15 : tauntLength(n)=86 : tauntLoop(n)=0
n=84 : tauntName$(n)="Come At Me"
tauntAnimStart(n)=4045 : tauntAnimEnd(n)=4131
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.1
tauntTransition(n)=15 : tauntLength(n)=86 : tauntLoop(n)=0
n=85 : tauntName$(n)="Here Comes The Pain"
tauntAnimStart(n)=4131 : tauntAnimEnd(n)=4217
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.6
tauntTransition(n)=15 : tauntLength(n)=86 : tauntLoop(n)=0
n=86 : tauntName$(n)="Break Down The Walls"
tauntAnimStart(n)=4217 : tauntAnimEnd(n)=4315
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.2
tauntTransition(n)=15 : tauntLength(n)=98 : tauntLoop(n)=0
n=87 : tauntName$(n)="We The People"
tauntAnimStart(n)=4315 : tauntAnimEnd(n)=4412
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.1
tauntTransition(n)=15 : tauntLength(n)=86 : tauntLoop(n)=0
n=88 : tauntName$(n)="Iced Z"
tauntAnimStart(n)=4412 : tauntAnimEnd(n)=4498
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.1
tauntTransition(n)=15 : tauntLength(n)=86 : tauntLoop(n)=0
n=89 : tauntName$(n)="Finish IT!"
tauntAnimStart(n)=4498 : tauntAnimEnd(n)=4584
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.1
tauntTransition(n)=15 : tauntLength(n)=86 : tauntLoop(n)=0
n=90 : tauntName$(n)="OOOH YEAH!"
tauntAnimStart(n)=4584 : tauntAnimEnd(n)=4670
tauntAnimSource(n)=1010 : tauntSpeed#(n)=0.9
tauntTransition(n)=15 : tauntLength(n)=86 : tauntLoop(n)=0
n=91 : tauntName$(n)="The Whole Show"
tauntAnimStart(n)=4670 : tauntAnimEnd(n)=4756
tauntAnimSource(n)=1010 : tauntSpeed#(n)=0.9
tauntTransition(n)=15 : tauntLength(n)=86 : tauntLoop(n)=0
n=92 : tauntName$(n)="Neck Twist"
tauntAnimStart(n)=4756 : tauntAnimEnd(n)=4842
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.2
tauntTransition(n)=15 : tauntLength(n)=86 : tauntLoop(n)=0
n=93 : tauntName$(n)="Cenation"
tauntAnimStart(n)=4842 : tauntAnimEnd(n)=4928
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.0
tauntTransition(n)=15 : tauntLength(n)=86 : tauntLoop(n)=0
n=94 : tauntName$(n)="Rebirth"
tauntAnimStart(n)=4928 : tauntAnimEnd(n)=5028
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.0
tauntTransition(n)=15 : tauntLength(n)=100 : tauntLoop(n)=0
n=95 : tauntName$(n)="Shout"
tauntAnimStart(n)=5028 : tauntAnimEnd(n)=5114
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.0
tauntTransition(n)=15 : tauntLength(n)=86 : tauntLoop(n)=0
n=96 : tauntName$(n)="3D"
tauntAnimStart(n)=5114 : tauntAnimEnd(n)=5200
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.4
tauntTransition(n)=15 : tauntLength(n)=86 : tauntLoop(n)=0
n=97 : tauntName$(n)="Verison 1"
tauntAnimStart(n)=5200 : tauntAnimEnd(n)=5286
tauntAnimSource(n)=1010 : tauntSpeed#(n)=1.1
tauntTransition(n)=15 : tauntLength(n)=76 : tauntLoop(n)=0
no_taunts=n
...
;///////////////////////////////////////////////////////
.Weapons
Global no_weaps=30,weapCount,weapLimit=100,weapList=43
...
Function LoadWeaponData()
 ...
 weapSize#(n)=10 : weapWeight#(n)=0.3 : weapDamage(n)=750
 weapHold(n)=3 : weapFlammable(n)=0 : weapExplodable(n)=0
 ...
 ;sledge hammer
 n=39
 weapName$(n)="Sledge Hammer" : weapFile$(n)="SledgeHamm"
 weapSound(n)=sImpactHammer : weapTex(n)=0 : weapShine#(n)=0.10
 weapSize#(n)=13 : weapWeight#(n)=0.4 : weapDamage(n)=750
 weapHold(n)=1 : weapFlammable(n)=0 : weapExplodable(n)=0
 weapStandard(n)=0 : weapValue(n)=800
 ;Saw
 n=40
 weapName$(n)="Chainsaw" : weapFile$(n)="Saw"
 weapSound(n)=sImpactGun : weapTex(n)=0 : weapShine#(n)=0.7
 weapSize#(n)=13 : weapWeight#(n)=0.5 : weapDamage(n)=1250
 weapHold(n)=1 : weapFlammable(n)=1 : weapExplodable(n)=1
 weapStandard(n)=0 : weapValue(n)=2400 
;newbelts
;us title
 n=41
 weapName$(n)="US TITLE" : weapFile$(n)="Belt"
 weapSound(n)=sBlock(7) : weapTex(n)=tBelt(5) : weapShine#(n)=1
 weapSize#(n)=7 : weapWeight#(n)=0.3 : weapDamage(n)=100
 weapHold(n)=0 : weapFlammable(n)=1 : weapExplodable(n)=0 
 weapStandard(n)=-1 : weapValue(n)=1000
...
;Womens title
 n=42
 weapName$(n)="Womens Title" : weapFile$(n)="Belt"
 weapSound(n)=sBlock(7) : weapTex(n)=tBelt(4) : weapShine#(n)=1
 weapSize#(n)=7 : weapWeight#(n)=0.3 : weapDamage(n)=100
 weapHold(n)=0 : weapFlammable(n)=1 : weapExplodable(n)=0 
 weapStandard(n)=-1 : weapValue(n)=1000
...
;TV title
 n=43
 weapName$(n)="TV Title" : weapFile$(n)="Belt"
 weapSound(n)=sBlock(7) : weapTex(n)=tBelt(6) : weapShine#(n)=1
 weapSize#(n)=7 : weapWeight#(n)=0.3 : weapDamage(n)=100
 weapHold(n)=0 : weapFlammable(n)=1 : weapExplodable(n)=0 
 weapStandard(n)=-1 : weapValue(n)=1000
...
.World
Global world
Global wGround#=1.9,wStage#=26.1 ;change ground from 1.6
